...
Route::get('/language/khmer', [LanguageController::class, 'Khmer'])->name('khmer.language');
...
// Wishlist page as group with middleware/must login
...
// Checkout & Shipping address routes
