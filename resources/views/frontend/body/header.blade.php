        ...
        <div class="header-top-inner">
          <div class="cnt-account">
            <ul class="list-unstyled">
                <li><a href="#"><i class="icon fa fa-user"></i>@if(session()->get('language') == 'khmer') គណនី​របស់ខ្ញុំ @else My Account @endif</a></li>
          ...
          <div class="cnt-block">
            <ul class="list-unstyled list-inline">
              ...
              <li class="dropdown dropdown-small">
                <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">
                    <span class="value">@if(session()->get('language') == 'khmer') ភាសាខ្មែរ @else Language @endif</span>
                    <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        @if (session()->get('language') == 'khmer')
                        <li><a href="{{ route('english.language') }}">English ភាសាអង់គ្លេស</a></li>
                        @else
                        <li><a href="{{ route('khmer.language') }}">Khmer ភាសាខ្មែរ</a></li>
                        @endif
                    </ul>
              </li>
            </ul>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
            ...
            <!-- End shopping card dropdown --> </div>
          <!-- /.top-cart-row -->
        </div>
        <!-- /.row -->
      </div>
            ...
            <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
              <div class="nav-outer">
                <ul class="nav navbar-nav">
                    ...
                    @if(session()->get('language') == 'khmer') គេហទំព័រ @else Home @endif</a></li>
                    <!-- Get ategory table data -->
                    @php $categories = App\Models\Category::orderBy('category_name_en','ASC')->get(); @endphp
                     @foreach($categories as $category)
                      <li class="dropdown yamm mega-menu"><a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">
                        @if(session()->get('language') == 'khmer') {{ $category->category_name_kh }} @else {{ $category->category_name_en }} @endif</a>
                            ...
                            <div class="yamm-content ">
                              <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                    ...
                                    <h2 class="title">@if(session()->get('language') == 'khmer') {{ $subcategory->subcategory_name_kh }} @else {{ $subcategory->subcategory_name_en }} @endif</h2>
                                    </a>
                                ...
                                @foreach($subsubcategories as $subsubcategory)
                                  <ul class="links">
                                    <li>
                                        ...
                                        @if(session()->get('language') == 'khmer') {{ $subsubcategory->subsubcategory_name_kh }} @else {{ $subsubcategory->subsubcategory_name_en }} @endif</a>
                                    </li>
                                  </ul>
