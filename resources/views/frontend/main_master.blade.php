...
<script type="text/javascript" src="{{ asset('frontend/zassets/js/lightbox.min.js') }}"></script>
    ...
    function wishlist(){
        $.ajax({
            ...
            success:function(response)
            {
                ...
                {
                    rows += `<tr>
                    <td class="col-md-2"><img src="/${value.product.product_thambnail} " alt="${value.product.product_name_en}"></td>
                    <td class="col-md-7">
                    ...
                    <td class="col-md-2">
                        <button class="btn-upper btn-primary icon" type="button" title="Add to cart" data-toggle="modal" data-target="#exampleModal" id="${value.product_id}" onclick="productView(this.id)">Add to Cart</button>
                    </td>
