...
<!--  /////////// This is for Brand Filder /////////////// -->
 ...
 <label class="form-check-label">
  ...
  @if(session()->get('language') == 'khmer') {{ $brand->brand_name_kh }} @else {{ $brand->brand_name_en }} @endif
      ...
      <div class="product">
        ...
        <div class="product-info text-left">
          <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
          	@if(session()->get('language') == 'khmer') {{ $product->product_name_kh }} @else {{ $product->product_name_en }} @endif</a></h3>
