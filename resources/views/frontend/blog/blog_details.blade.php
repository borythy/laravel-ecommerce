			...
			<div class="blog-page">
				<div class="col-md-9">
					<div class="blog-post wow fadeInUp">
                        <img class="img-responsive" src="{{ asset($blogpost->post_image) }}" alt="{{ $blogpost->post_title_en }}">
                        <h1>@if(session()->get('language') == 'khmer') {{ $blogpost->post_title_kh }} @else {{ $blogpost->post_title_en }} @endif</h1>
                        <span class="date-time">{{ Carbon\Carbon::parse($blogpost->created_at)->diffForHumans() }}</span>

                        <p> @if(session()->get('language') == 'khmer') {!! $blogpost->post_details_kh !!} @else {!! $blogpost->post_details_en !!} @endif</p>
