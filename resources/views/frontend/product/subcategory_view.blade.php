    ...
    <div class='container'>
        <div class='row'>
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a href="#collapse{{ $category->id }}" data-toggle="collapse" class="accordion-toggle collapsed">
                                                @if(session()->get('language') == 'khmer') {{ $category->category_name_kh }} @else {{ $category->category_name_en }} @endif
                                            </a>
                                        </div>
                                            ...
                                            <div class="accordion-inner">
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        @if(session()->get('language') == 'khmer') {{ $subcategory->subcategory_name_kh }} @else {{ $subcategory->subcategory_name_en }} @endif</a>
                                                    </li>
                                                </ul>
                                                @endforeach
            ...
            <div class="ajax-loadmore-product text-center" style="display: none">
                <img src="{{ asset('frontend/assets/images/loading.svg') }}" style="width: 120px; hight: 120px;">
            </div>
        </div> <!-- /.row -->
