                        ...
                        <div class="col-xs-12 col-sm-6 col-md-5 gallery-holder">
                            <div class="product-item-holder size-big single-product-gallery small-gallery">
                                <div id="owl-single-product">
                                    ...
                                    <div class="single-product-gallery-item" id="slide{{ asset($img->id) }}">
                                        <a data-lightbox="image-1" data-title="Gallery" href="{{ asset($img->photo_name) }}">
                                        <img class="img-responsive" alt="{{ asset($img->product_id) }}" src="{{ asset($img->photo_name) }}" data-echo="{{ asset($img->photo_name) }}" />
                                        </a>
                                    ...
                                    <div id="owl-single-product-thumbnails">
                                        ...
                                        <div class="item">
                                            <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide{{ $img->id }}">
                                                <img class="img-responsive" width="85" alt="{{ asset($img->product_id) }}" src="{{ asset($img->photo_name) }}" data-echo="{{ asset($img->photo_name) }}" />
                                            </a>
                                        </div>
                                        @endforeach
                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                ...
                                <div class="description-container m-t-20">
                                    @if(session()->get('language') == 'khmer') {{ $product->short_descp_kh }} @else {{ $product->short_descp_en }} @endif
                            ...
                            <div class="tab-content">
                                <div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <p class="text">@if(session()->get('language') == 'khmer')
                                            {!! $product->long_descp_kh !!} @else {!! $product->long_descp_en !!} @endif
                                        </p>
                                    </div>
                                        ...
                                        <div class="product-add-review">
                                            <div class="tab-pane" id="review">
                                                <div class="product-tab">
                                                            ...
                                                            @foreach($reviews as $item)
                                                                ...
                                                                <div class="review">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6"></div> <!-- /.col-md-6 end -->
                                                                    </div> <!-- /.row end -->
                                                    ...
                                                    </div><!-- /.product-reviews end -->
                                                    <div class="product-add-review">
                                                        <h4 class="title">Write your own review</h4>
                                                        <div class="review-table"></div><!-- /.review-table -->
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                ...
                                                <img src="{{ asset($product->product_thambnail) }}" alt="{{ asset($product->product_name_en) }}"></a>
                                            </div><!-- /.image -->
