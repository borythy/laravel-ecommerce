                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row"> <!-- start 2nd row -->
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h5>Product English Name <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h5>Product Khmer Name <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <input type="text" name="product_name_kh" value="{{ $products->product_name_kh }}" class="form-control" required="">
                                                </div>
                                    ...
                                    <div class="row"> <!-- start 3rd row -->
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_tags_en" value="{{ $products->product_tags_en }}" class="form-control" data-role="tagsinput" required="">
                                                </div>
                                    ...
                                    <div class="row"> <!-- start 4th row -->
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h5>Product Tags Khmer <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <input type="text" name="product_tags_kh" value="{{ $products->product_tags_kh }}" class="form-control" data-role="tagsinput" required="">
                                                </div>
                                                @error('product_tags_kh')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div> <!-- /.col-md-4 end -->
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h5>Product Size Khmer <span class="text-danger"></span></h5>
                                                <div class="controls">
                                                    <input type="text" name="product_size_kh" value="{{ $products->product_size_kh }}" class="form-control" data-role="tagsinput">
                                                </div>
                                                @error('product_size_kh')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div> <!-- /.col-md-4 end -->
                                    </div> <!-- start 4th row end -->
                                    <div class="row"> <!-- start 5th row -->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Product Color English <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <input type="text" name="product_color_en" value="{{ $products->product_color_en }}" class="form-control" data-role="tagsinput" required="">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Product Color Khmer <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <input type="text" name="product_color_kh" value="{{ $products->product_color_kh }}" class="form-control" data-role="tagsinput" required="">
                                                </div>
                                                @error('product_color_kh')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div> <!-- /.col-md-6 end -->
                                    ...
                                    <div class="row"> <!-- start 7th row -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Short Description Khmer <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <textarea name="short_descp_kh" id="textarea" class="form-control" required placeholder="Textarea text">
                                                        {!! $products->short_descp_kh !!}
                                                    </textarea>
                                                </div>
                                                @error('short_descp_kh')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div> <!-- /.col-md-4 end-->
                                    </div> <!-- start 7th row end -->
                                    <div class="row"> <!-- start 8th row -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Long Description Khmer <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <textarea id="editor2" name="long_descp_kh" rows="10" cols="80" required="">
                                                        {!! $products->long_descp_kh !!}
                                                    </textarea>
                                                </div>
                                                @error('long_descp_kh')
                                                <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            <fieldset>
                                                <input type="checkbox" id="checkbox_2" name="hot_deals" {{ $products->hot_deals == 1 ? 'checked': '' }} value="1">
                                                <label for="checkbox_2">Hot Deals</label>
                                            </fieldset>
                                            <fieldset>
                                                <input type="checkbox" id="checkbox_3" name="featured" {{ $products->featured == 1 ? 'checked': '' }} value="1">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            <fieldset>
                                                <input type="checkbox" id="checkbox_4" name="special_offer" {{ $products->special_offer == 1 ? 'checked': '' }} value="1">
                                                <label for="checkbox_4">Special Offer</label>
                                            </fieldset>
                                            <fieldset>
                                                <input type="checkbox" id="checkbox_5" name="special_deals" {{ $products->special_deals == 1 ? 'checked': '' }} value="1">
