...
class IndexController extends Controller
{
    ...
    public function ProductDetails($id, $slug)
    {
        ...
        $color_kh = $product->product_color_kh;
        $product_color_kh = explode(',', $color_kh);

        $size_en = $product->product_size_en;
        $product_size_en = explode(',', $size_en);

        $size_kh = $product->product_size_kh;
        $product_size_kh = explode(',', $size_kh);
    ...
    public function SubCatWiseProduct(Request $request, $subcat_id, $slug)
    {
        ...
        // Load More Product with Ajax start
        if ($request->ajax()) {
        ...
        // Load More Product with Ajax end
