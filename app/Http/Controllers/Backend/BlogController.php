...
class BlogController extends Controller
{
    ...
    public function BlogCategoryStore(Request $request)
    {
        $request->validate([
            ...
            'blog_category_name_kh' => 'required',
        ], [
            'blog_category_name_en.required' => 'Input Blog Category English Name',
            'blog_category_name_kh.required' => 'Input Blog Category Hindi Name',
        ]);

        BlogPostCategory::insert([
            'blog_category_name_en' => $request->blog_category_name_en,
            'blog_category_name_kh' => $request->blog_category_name_kh,
            'blog_category_slug_en' => strtolower(str_replace(' ', '-', $request->blog_category_name_en)),
            'blog_category_slug_kh' => str_replace(' ', '-', $request->blog_category_name_kh),
    ...
    public function BlogPostStore(Request $request)
    {
        $request->validate([
            ...
            'post_title_kh.required' => 'Input Post Title Khmer Name',
        ]);
        ...
        BlogPost::insert([
            ...
            'post_title_kh' => $request->post_title_kh,
            'post_slug_en' => strtolower(str_replace(' ', '-', $request->post_title_en)),
            'post_slug_kh' => str_replace(' ', '-', $request->post_title_kh),
            'post_image' => $save_url,
            'post_details_en' => $request->post_details_en,
            'post_details_kh' => $request->post_details_kh,
            'created_at' => Carbon::now(),
        ]);
